...
export default function SignUp() {
  return (
    <section className="relative" data-aos="fade-up" data-aos-delay="400">
      <div data-aos="fade-up" data-aos-delay="400" className="max-w-6xl mx-auto px-4 sm:px-6" >
        <div className="pt-32 pb-12 md:pt-40 md:pb-20" data-aos="fade-up" data-aos-delay="400" >
